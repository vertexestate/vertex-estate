...
export const margallaLocation = {
  ...
  advantages: [
    ...
    { icon: '🏙️', text: 'Taramri Chowk, about 1 minute away' },
    { icon: '🌿', text: 'Park Enclave, about 3 minutes' },
    { icon: '🏘️', text: 'Chak Shahzad, about 5 minutes' },
    { icon: '🏗️', text: 'Bahria Enclave, about 12 minutes' },
  ...
  landmarks: [
    ...
    { place: 'Taramri Chowk', time: '~1 min', notes: 'Nearest junction' },
    { place: 'Park Enclave', time: '~3 min', notes: 'Residential enclave' },
    { place: 'Chak Shahzad', time: '~5 min', notes: 'Nearest town' },
    { place: 'Bahria Enclave', time: '~12 min', notes: 'Via Kuri Road' },
    { place: 'Blue Area (CBD)', time: '~10 min', notes: 'Business district' },
